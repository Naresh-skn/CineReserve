...
import com.project.cineReserve.entity.ShowSeat;
...
public interface ShowSeatRepository extends JpaRepository<ShowSeat, Long> {
    ...
    @Query("SELECT s FROM ShowSeat s WHERE s.showSeatId IN :seatIds AND " +
            "(s.bookingStatus = com.project.cineReserve.entity.BookingStatus.UNRESERVED OR " +
            "(s.bookingStatus = com.project.cineReserve.entity.BookingStatus.RESERVED_PAYMENT_PENDING" +
